...
def test(
    ...
    logger.info("Args: %s", args)
        ...
        # Apply the PromptAgent patch for compressed tables
    from prompt_agent_patch import apply_prompt_agent_patch
    if apply_prompt_agent_patch():
        logger.info("Successfully patched PromptAgent for compressed tables")
    else:
        logger.warning("Failed to patch PromptAgent for compressed tables, continuing without compression support")
